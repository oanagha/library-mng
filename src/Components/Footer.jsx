...
function Footer() {
  return (
    <>
      ...
      <MDBFooter className='text-center mt-4' color='' bgColor='secondary' >
          ...
          <section className=''>
            <form action='' >
              <MDBRow className='d-flex justify-content-center'>
                ...
                <MDBCol md='5' start>
                  <MDBInput contrast type='email' label='Email address ' placeholder='Enter your Email' className='mb-4  ' />
                </MDBCol>
        ...
        <div className='text-center text-dark p-3' style={{ backgroundColor: 'gray' }}>
          © 2020 Copyright:
          <a className='text-dark' href='https://minilibrary.com/'>
            minilibrary.com
          </a>
        </div>
      </MDBFooter>
